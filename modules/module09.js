...
function getContent() {
    return `
        <div class="module-content">
            ...
            <img src="images/image091.png" alt="Transfection overview diagram" class="my-4 rounded-lg shadow-md mx-auto block max-w-full sm:max-w-7xl w-auto enlarged-image" onerror="this.onerror=null; this.src='https://placehold.co/500x300/e2e8f0/4a5568?text=Image+91:+Transfection+Overview'; this.alt='Placeholder: Transfection Overview';">
...
<div class="transfection-methods">
    ...
    <div class="transfection-method-category" data-category="viral">
        ...
        <div class="category-details hidden">
            ...
            <img src="images/image092.png" alt="Calcium phosphate transfection mechanism" class="my-4 rounded-lg shadow-md mx-auto block max-w-full sm:max-w-7xl w-auto enlarged-image" onerror="this.onerror=null; this.src='https://transfection.bocsci.com/upload/image/Calcium-phosphate-transfection-2.png'; this.alt='Placeholder: CaPi Mechanism';">
