    ...
    return `
        <div class="module-content">
            ...
            <div class="my-8 text-center">
                <img src="images/image0301.png" alt="Experimental workflow overview diagram" class="rounded-lg shadow-md mx-auto block max-w-full w-auto" onerror="this.onerror=null; this.src='https://placehold.co/600x400/e2e8f0/4a5568?text=Experimental+Workflow+Overview'; this.alt='Placeholder: Experimental Workflow Overview';">
