...
function getContent() {
    return `
        <div class="module-content">
            ...
            <img src="images/image0901.png" alt="Transfection overview diagram" class="my-4 rounded-lg shadow-md mx-auto block w-[600px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/500x300/e2e8f0/4a5568?text=Image+91:+Transfection+Overview'; this.alt='Placeholder: Transfection Overview';">
...
<div class="transfection-methods">
    ...
    <div class="transfection-method-category" data-category="viral">
        ...
        <div class="category-details hidden">
            ...
            <img src="images/image0902.png" alt="Calcium phosphate transfection mechanism" class="my-4 rounded-lg shadow-md mx-auto block w-[600px] max-w-full" onerror="this.onerror=null; this.src='https://transfection.bocsci.com/upload/image/Calcium-phosphate-transfection-2.png'; this.alt='Placeholder: CaPi Mechanism';">
            ...
            <div class="interactive-box">
                ...
                <img src="images/image0903.png" alt="24-well plate pipetting scheme" class="my-2 rounded-lg shadow-md mx-auto block w-[400px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/300x200/e2e8f0/4a5568?text=Image+93:+24-Well+Plate+Scheme'; this.alt='Placeholder: 24-Well Plate Scheme';">
            ...
            <img src="images/image0904.png" alt="HEK cells after calcium phosphate transfection" class="my-4 rounded-lg shadow-md mx-auto block w-[350px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/500x300/e2e8f0/4a5568?text=Image+94:+HEK+Cells+Post-Transfection'; this.alt='Placeholder: HEK Cells Post-Transfection';">
        ...
        <div class="qa-answer hidden">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
                <div class="text-center">
                    <img src="images/image0905.png" alt="pH2B-GFP plasmid map" class="rounded-lg shadow-md mx-auto block w-[350px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/300x300/e2e8f0/4a5568?text=Image+95:+pH2B-GFP+Plasmid'; this.alt='Placeholder: pH2B-GFP Plasmid Map';">
                    <p class="text-sm mt-2 font-semibold">Plasmid map of pH2B-GFP used in the practical course. Can be bought e.g. on addgene</p>
                </div>
                <div class="text-center">
                    <img src="images/image0906.png" alt="plL001_3xFLAG-LMNB1 plasmid map" class="rounded-lg shadow-md mx-auto block w-[350px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/300x300/e2e8f0/4a5568?text=Image+96:+plL001_3xFLAG-LMNB1+Plasmid'; this.alt='Placeholder: plL001_3xFLAG-LMNB1 Plasmid Map';">
