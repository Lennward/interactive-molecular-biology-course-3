...
function getContent() {
    return `
        <div class="module-content">
            ...
            <img src="images/image1001.png" alt="The image shows the basic principle of fluorescence" class="my-4 rounded-lg shadow-md mx-auto block max-w-full sm:max-w-lg w-auto" onerror="this.onerror=null; this.src='https://placehold.co/500x400/e2e8f0/4a5568?text=Image+101:+Fluorescence+Principle'; this.alt='Placeholder: Fluorescence Principle';">
            ...
            <img src="images/image1002.png" alt="How a fluorescence microscope works" class="my-4 rounded-lg shadow-md mx-auto block max-w-full sm:max-w-md w-auto" onerror="this.onerror=null; this.src='https://placehold.co/400x400/e2e8f0/4a5568?text=Image+102:+Fluorescence+Microscope'; this.alt='Placeholder: Fluorescence Microscope';">
