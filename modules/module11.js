...
function getContent() {
    return `
        <div class="module-content">
            ...
            <img src="images/image111.png" alt="The direct and indirect verification method of ICC" class="my-4 rounded-lg shadow-md mx-auto block w-[650px] max-w-full" onerror="this.onerror=null; this.src='https://placehold.co/500x200/e2e8f0/4a5568?text=Figure+4:+Direct+and+Indirect+ICC+Methods'; this.alt='Placeholder: Direct and Indirect ICC Methods';">
